...
export async function sendPopupEmails(
  ...
  try {
    ...
    const clientMailOptions: any = {
      from: `Online Exam Relief Alert - Discount Recieved <${process.env.MAILFROM}>`,
      to: email,
