        ...
        <Card>
          ...
          <CardContent className="space-y-2 ">
            ...
            <div className="flex justify-between  ">
              <button onClick={onPrevious} className='py-1 rounded-lg bg-sky-700 text-white text-center m-4 w-[120px] hover:scale-105 transition ease-in duration-200 font-medium'>
                PREVIOUS
              </button>
              <button type="submit" disabled={pending} className="flex m-5 py-3 px-5 bg-sky-700 text-zinc-50 rounded-lg hover:scale-105 transition ease-in duration-200 delay-200 font-medium">
                {pending ? (
                  <>
