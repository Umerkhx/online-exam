        ...
        <div>
            <Card>
                ...
                <div className='flex justify-end '>
                    <button onClick={onNext} className='py-3 rounded-lg bg-sky-700 text-white text-center m-4 w-[100px] hover:scale-105 transition ease-in duration-200 font-semibold'>NEXT</button>
                    </div>
            </Card>
