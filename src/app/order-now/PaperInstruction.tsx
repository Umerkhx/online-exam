        ...
        <div>
            <Card>
                ...
                <div className='flex justify-between'>
                    <button onClick={onPrevious} className='py-3 rounded-lg bg-sky-700 text-white text-center m-4 w-[100px] hover:scale-105 transition ease-in duration-200 font-medium'>
                        PREVIOUS
                    </button>
                    <button onClick={onNext} className='py-3 rounded-lg bg-sky-700 text-white text-center m-4 w-[100px] hover:scale-105 transition ease-in duration-200 font-medium'>
                        NEXT
                    </button>
                </div>
            </Card>
