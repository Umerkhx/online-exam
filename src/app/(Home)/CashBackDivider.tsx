...
export const CashbackDivider = () => {
  ...
  return (
    <div className="relative lg:pt-20 pt-36">
      ...
      <div className="absolute -top-12 sm:-top-16 md:-top-20 left-1/2 transform -translate-x-1/2 z-10 w-full px-4 sm:px-6">
        <div className="w-full max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-5xl mx-auto">
          {/* Main banner card */}
          <div className="relative bg-gradient-to-tr from-neutral-950 via-neutral-900 to-sky-800 rounded-xl sm:rounded-2xl p-3 sm:p-5 md:py-4 md:px-6 border border-sky-700/50 shadow-2xl overflow-hidden">
            ...
            <div className="absolute top-3 left-5 text-sky-300/60">
              <Sparkles className="w-5 h-5 animate-pulse" />
            </div>
            
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6 items-center">
              {/* Left Content */}
              <div className=" text-center md:text-left lg:pl-20">
                <div className="space-y-2 sm:space-y-3">
                  <div>
                    ...
                    <h3 className="text-3xl md:text-4xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-sky-100 to-sky-200 mb-1 sm:mb-2 leading-tight">
                      10% Cashback
                    </h3>
