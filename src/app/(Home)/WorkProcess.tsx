    ...
    <div className='mt-12 mx-auto max-w-screen-xl'>
        ...
        <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 mt-5 p-2 md:p-5 scale-95 md:scale-100 '>
                <div data-aos='flip-up' className='group'>
                    <div className='group-hover:scale-105  group-hover:shadow-xl transition ease-in duration-500 delay-400 lg:h-[350px] rounded-xl shadow-xl bg-gradient-to-br from-blue-400 to-purple-400 dark:bg-gradient-to-br dark:from-blue-900 dark:to-purple-900 p-5'>
