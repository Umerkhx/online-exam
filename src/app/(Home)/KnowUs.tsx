...
function KnowUs() {
  ...
  <div className="relative">
    ...
    <div className="absolute lg:top-52 top-40 lg:left-[18rem] left-[9rem] lg:w-[18rem] w-[13rem] lg:h-[18rem] h-[12rem] overflow-hidden rounded-lg shadow-lg border-2 border-white">
