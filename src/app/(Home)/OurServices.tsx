  ...
  return (
    <div className='mt-10 mx-auto max-w-screen-xl'>
      <div className='flex justify-center items-center'>
        <div className='rounded-full px-3 py-1 bg-gradient-to-br from-blue-600 to-purple-400 dark:bg-gradient-to-br dark:from-blue-900 dark:to-purple-900 text-zinc-100 text-center w-72'>Your Journey to Success Starts Here</div>
      </div>
      ...
      <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-3 p-3 mt-5'>
        <div className='group'>
          <div className='p-4 scale-95 bg-gradient-to-br from-blue-400 to-purple-400 dark:bg-gradient-to-br dark:from-blue-900 dark:to-purple-900 shadow-lg rounded-lg group-hover:-translate-y-3 transition ease-in duration-300 delay-300 h-[320px] text-gray-100'>
