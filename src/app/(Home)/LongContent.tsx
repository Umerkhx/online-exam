...
function LongContent() {
  return (
      ...
      <div className="max-h-[600px] overflow-y-auto p-6 bg-white dark:bg-zinc-900 rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-700 space-y-5">
        ...
        <h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Our Services Include</h3>
        ...
        <h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Why Choose Us?</h3>
        <ul className="list-disc list-inside text-zinc-600 dark:text-zinc-300">
        ...
        <h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">How It Works</h3>
        <ol className="list-decimal list-inside text-zinc-600 dark:text-zinc-300">
        ...
        <h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Subjects We Cover</h3>
        <ul className="list-disc list-inside text-zinc-600 dark:text-zinc-300">
 ...
 <h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Plagiarism-Free Guarantee</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Expert Tutors</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Deadline-Oriented Workflow</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Confidentiality First</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Flexible Payment Options</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Real-Time Progress Tracking</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Discussion Boards & Forums</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Take-Home Exams & Timed Tests</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Essay & Research Paper Assistance</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Group Project Support</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Live Class Participation</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Academic Honesty Policy</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Client Testimonials</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Get Started Today</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<p className="text-zinc-600 dark:text-zinc-300">
  From there, sit back and relax—we’ll handle the rest. Because your success is our mission.
        ...
        <h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Exam Assistance Services</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Assignment Help Services</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Test Preparation Packages</h3>
<p className="text-zinc-600 dark:text-zinc-300">
...
<h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100">Emergency Exam Support</h3>
<p className="text-zinc-600 dark:text-zinc-300">
