...
function Faq() {
    return (
        <div className='mt-20 mx-auto max-screen-w-xl'>
            ...
            <div className='grid lg:grid-cols-3 grid-cols-1 gap-4 p-4 mt-5'>
                ...
                <div className='col-span-2'>
                    <Accordion className='space-y-3' type="single" collapsible>
                        <AccordionItem className='bg-gradient-to-br from-blue-400 to-purple-400 text-gray-100 dark:bg-gradient-to-br dark:from-blue-900 dark:to-purple-900 p-2 rounded-lg' value="item-1">
                        ...
                        <AccordionItem className='bg-gradient-to-br from-blue-400 to-purple-400 text-gray-100 dark:bg-gradient-to-br dark:from-blue-900 dark:to-purple-900 p-2 rounded-lg' value="item-2">
                        ...
                        <AccordionItem className='bg-gradient-to-br from-blue-400 to-purple-400 text-gray-100 dark:bg-gradient-to-br dark:from-blue-900 dark:to-purple-900 p-2 rounded-lg' value="item-3">
                        ...
                        <AccordionItem className='bg-gradient-to-br from-blue-400 to-purple-400 text-gray-100 dark:bg-gradient-to-br dark:from-blue-900 dark:to-purple-900 p-2 rounded-lg' value="item-4">
