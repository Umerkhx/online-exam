            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="rounded-lg w-full py-3 px-3 outline-none text-sm md:text-base bg-white text-black  dark:page-specific focus:!outline-none border border-gray-300 pl-10"
              ...
              <div>
                ...
                <PhoneInput
                  ...
                  onChange={setPhone}
                  className="rounded-lg w-full py-3 px-3 outline-none text-sm md:text-base bg-white text-black  dark:page-specific focus:!outline-none border border-gray-300"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={!isVerified}
                className="w-full bg-sky-700 hover:bg-sky-600 text-white font-bold py-4 px-4 rounded-lg transition-all duration-200 shadow-md"
              >
                {pending ? (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  name="name"
                  placeholder="Enter your full name"
                  className="rounded-lg w-full py-3 px-3 outline-none text-sm md:text-base bg-white text-black  dark:page-specific focus:!outline-none border border-gray-300 pl-10 p-3"
                  onChange={(e) => setName(e.target.value)}
                  value={name}
                />
                {name === "" && (
